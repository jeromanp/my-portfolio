...
export const aboutMe = {
  intro:
    "Me apasiona el conocimiento y tengo un gusto por aprender cosas nuevas, me gusta leer artículos, noticias o publicaciones sobre temas que me interesan, tengo un gusto especial por la tecnología, astronomía, paleontología, historia, geografía y biología, lo que me ha llevado a ser una persona con conocimiento en diferentes áreas.",
  estudio:
  ...
  experiencia:
    "Trabajé cerca de 2 años en una empresa proveedora de servicio de internet a nivel nacional, en donde me encargaba de la operación, instalación, revisión y mantenimiento de los equipos que proporcionaban el servicio de video, voz y datos a sus suscriptores",
};
...
export const proyectos = {
  ...
  parrafo_2: "Es por ello que a continuación se describen aquellos proyectos que tuvieron un impacto importante en mi carrera y que me ayudaron a mejorar y perfeccionar parte de las cosas que iba aprendiendo",
};
...
export const misProyectos = [
  ...
  },
  {
    ...
    tecnologies:"Javascript, React JS, Redux, Node, Express JS, Sequelize/PostgreSQL, CSS Modules.",
  ...
  },
  {
    ...
    production:"Control de versiones: GitHub , Base de datos: Supabase, BackEnd y FrontEnd: Vercel.",
